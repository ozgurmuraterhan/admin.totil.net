  ...
  return (
    <>
      <div className="w-full flex flex-wrap mb-6">
        <div className="w-full sm:w-2/4 xl:w-1/4 sm:px-3 sm:ps-0 mb-6 xl:mb-0">
          <StickerCard
        ...
        <div className="w-full sm:w-2/4 xl:w-1/4 sm:px-3 sm:pe-0 xl:pe-3 mb-6 xl:mb-0">
          <StickerCard
        ...
        <div className="w-full sm:w-2/4 xl:w-1/4 sm:px-3 sm:pe-0 xl:ps-3 mb-6 xl:mb-0">
          <StickerCard
